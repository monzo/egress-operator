...
func (in *ExternalServiceSpec) DeepCopyInto(out *ExternalServiceSpec) {
	*out = *in
	...
	if in.IpOverride != nil {
		in, out := &in.IpOverride, &out.IpOverride
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.EnvoyClusterMaxConnections != nil {
		in, out := &in.EnvoyClusterMaxConnections, &out.EnvoyClusterMaxConnections
		*out = new(uint32)
		**out = **in
	}
	out.TopologySpreadSkews = in.TopologySpreadSkews
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TopologySpreadSkews) DeepCopyInto(out *TopologySpreadSkews) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TopologySpreadSkews.
func (in *TopologySpreadSkews) DeepCopy() *TopologySpreadSkews {
	if in == nil {
		return nil
	}
	out := new(TopologySpreadSkews)
	in.DeepCopyInto(out)
	return out
}
